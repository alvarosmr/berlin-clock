...
public class BerlinClockTimeTest {
    ...
    void when_TimeIsGiven_expect_CorrectLampsOnSingleMinutesRow(int minutes, int lampsOnSingleMinutesRow) {
        BerlinClockTime result = BerlinClockTime.valueOf(LocalTime.of(0, Integer.valueOf(minutes), 0));

        assertEquals(lampsOnSingleMinutesRow, result.getLampsOnSingleMinutesRow(),
                "Wrong number of lamps on in the single minutes row");
    }
    ...
    void when_TimeIsGiven_expect_CorrectLampsOnFiveMinutesRow(int minutes, int lampsOnFiveMinutesRow) {
        BerlinClockTime result = BerlinClockTime.valueOf(LocalTime.of(0, Integer.valueOf(minutes), 0));

        assertEquals(lampsOnFiveMinutesRow, result.getLampsOnFiveMinutesRow(),
                "Wrong number of lamps on in the five minutes row");
    }
    ...
    void when_TimeIsGiven_expect_CorrectLampsOnSingleHoursRow(int hours, int lampsOnSingleHoursRow) {
        BerlinClockTime result = BerlinClockTime.valueOf(LocalTime.of(Integer.valueOf(hours), 0, 0));

        assertEquals(lampsOnSingleHoursRow, result.getLampsOnSingleHoursRow(),
                "Wrong number of lamps on in the single hours row");
    }
    ...
    void when_TimeIsGiven_expect_CorrectLampsOnFiveHoursRow(int hours, int lampsOnFiveHoursRow) {
        BerlinClockTime result = BerlinClockTime.valueOf(LocalTime.of(Integer.valueOf(hours), 0, 0));

        assertEquals(lampsOnFiveHoursRow, result.getLampsOnFiveHoursRow(),
                "Wrong number of lamps on in the five hours row");
    }
